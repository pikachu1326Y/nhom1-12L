...
<head>
 ...
 <marquee><p style=" color: #3c6382; font-weight: bond; font-size: 2em; font-family: Verdana;"> Nhóm 1 Kính chào thầy Đức ạ</p></marquee>
  ...
  <span class=" gradient"><p style=” font-size: 100px; font-weight: 700; background: linear-gradient(to right,  #eb4d4b, #6ab04c);  -webkit-background-clip: text; color: transparent;”>Nhóm 1-Lớp 12 L-Trường THPT Chuyên Bến Tre</p></span>
